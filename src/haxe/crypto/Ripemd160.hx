...
class Ripemd160
{
    ...
    private var KL:Vector<Int>;
    private var KR:Vector<Int>;
    private var RL:Vector<Int>;
    private var RR:Vector<Int>;
    private var SL:Vector<Int>;
    private var SR:Vector<Int>;

    private var KL_ARRAY = [0x00000000, 0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC, 0xA953FD4E];
	private var KR_ARRAY = [0x50A28BE6, 0x5C4DD124, 0x6D703EF3, 0x7A6D76E9, 0x00000000];

    private var RL_ARRAY = [
	...
	{
        state = Vector.fromArrayCopy([0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0]);
    }

    public function new()
    {
        KL = Vector.fromArrayCopy(KL_ARRAY);
        KR = Vector.fromArrayCopy(KR_ARRAY);
        RL = Vector.fromArrayCopy(RL_ARRAY);
        RR = Vector.fromArrayCopy(RR_ARRAY);
        SL = Vector.fromArrayCopy(SL_ARRAY);
        SR = Vector.fromArrayCopy(SR_ARRAY);
