...
class Sha384 {
	...
	public static function encode(s:String #if haxe4, ?encoding:haxe.io.Encoding #end):String {
		#if php
		#if haxe4
		return php.Global.hash('sha384', s);
		#else
		return untyped __php__("hash('sha384', {0})", s);
		#end
		#else
	...
	public static function make(b:haxe.io.Bytes):haxe.io.Bytes {
		#if php
		#if haxe4
		return Bytes.ofData(php.Global.hash('sha384', b.getData(), true));
		#else
		return Bytes.ofData(untyped __php__("hash('sha384', {0}, true)", b.getData()));
		#end
		#else
		var out = new Sha384().doEncode(b);
		return out;
		#end
	}
