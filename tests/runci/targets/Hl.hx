...
class Hl {
	...
	static public function getHlDependencies() {
		...
		switch (systemName) {
			case "Linux":
				Linux.requireAptPackages(["libturbojpeg-dev=2.0.3-0ubuntu1.20.04.3","libmbedtls-dev","libopenal-dev","libpng-dev","libsdl2-dev","libuv1-dev","libvorbis-dev","libsqlite3-dev","ninja-build"]);
			case "Mac":
