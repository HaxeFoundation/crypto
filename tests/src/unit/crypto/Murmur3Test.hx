...
class Murmur3Test extends Test
{
	public function test():Void
    {
		...
		eq(Murmur3.hash(sb("Haxe is great!")),2086637627);
		eq(Murmur3.hash(sb("Haxe is an open source high-level strictly-typed programming language with a fast optimizing cross-compiler."),0),2068081906);
		eq(Murmur3.hash(sb("Haxe is an open source high-level strictly-typed programming language with a fast optimizing cross-compiler."),25),2386375015);
		eq(Murmur3.hash(sb("Haxe is an open source high-level strictly-typed programming language with a fast optimizing cross-compiler."),128),3836537046);
		eq(Murmur3.hash(sb("Haxe can build cross-platform applications.")),2309495466);
		eq(Murmur3.hash(sb("")),0);
		eq(Murmur3.hash(sb("0")),3530670207);
		eq(Murmur3.hash(sb("01")),1642882560);
		eq(Murmur3.hash(sb("012")),3966566284);
		eq(Murmur3.hash(sb("0123")),3558446240);
		eq(Murmur3.hash(sb("01234")),433070448);
		eq(Murmur3.hash(sb("012345")),1898502397);
		eq(Murmur3.hash(sb("0123456")),183447976);
		eq(Murmur3.hash(sb("01234567")),1451431763);
		eq(Murmur3.hash(sb("012345678")),1350687357);
		eq(Murmur3.hash(sb("0123456789")),1891213601);
		eq(Murmur3.hash(sb("0123456789a")),3564907726);
		eq(Murmur3.hash(sb("0123456789ab")),2044149191);
		eq(Murmur3.hash(sb("0123456789abc")),4193546897);
		eq(Murmur3.hash(sb("0123456789abcd")),439890777);
		eq(Murmur3.hash(sb("0123456789abcde")),2250527230);
		eq(Murmur3.hash(sb("0123456789abcdef")),919068895);
		eq(Murmur3.hash(sb(""),1),1364076727);
		...
		eq(Murmur3.hash128(sb("Haxe is an open source high-level strictly-typed programming language with a fast optimizing cross-compiler."),0),"a44424f6365965981fb15205bd1e9d0");
